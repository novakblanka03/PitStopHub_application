...
public class UserConverter {
    ...
    public static final UserTO convertToTO(User entity) {
        return new UserTO(entity.getId(), entity.getFirstName(),
                entity.getLastName(), entity.getEmail(), entity.getPhone(), entity.getKnowledge());
    }

    public static final User convertToEntity(UserTO to) {
        return new User(to.getId(), to.getFirstName(), to.getLastName(), to.getEmail(), to.getPhone(), null, to.getKnowledge()
        );
    }

    public static final User convertToEntity(UserCTO to) {
        return new User(to.getId(), to.getPassword(), to.getFirstName(), to.getLastName(), to.getEmail(), to.getPhone(), null, to.getKnowledge());
    }
